...
UPDATE crimedata_cleaned
SET "LATITUDE" = SUBSTRING(SPLIT_PART("Location", ' ', 2), 2);
...
COPY crimedata_cleaned TO 'C:\Users\ivan\Documents\data portfolio\Oakland crime' DELIMITER ',' CSV HEADER;
...
SELECT "CASENUMBER", COUNT(*) CASENUMBERCOUNT FROM crimedata 
GROUP BY "CASENUMBER"
ORDER BY CASENUMBERCOUNT DESC
LIMIT 10

SELECT * FROM crimedata
WHERE "CASENUMBER" = '24-026797'

SELECT "DESCRIPTION", COUNT(*) DESCRIPTIONCOUNT FROM crimedata 
GROUP BY "DESCRIPTION"
ORDER BY DESCRIPTIONCOUNT DESC
LIMIT 10
	 
SELECT "CRIMETYPE", "DESCRIPTION" FROM crimedata_cleaned
WHERE "DESCRIPTION" LIKE '%GAMB%'

SELECT "CRIMETYPE", "DESCRIPTION" FROM crimedata_cleaned
WHERE "CRIMETYPE" LIKE '%GAMB%'
